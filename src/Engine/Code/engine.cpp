...
void Init(App* app)
{
    ...
    app->lights.push_back({ LightType_Point, vec3(0.0f, 1.0f, 0.0f), vec3(1.0f, 0.0f, 0.0f), vec3(-50.0f, 5.0f, 50.0f), 20.0, 1.5, true });
    app->lights.push_back({ LightType_Point, vec3(0.0f, 0.0f, 1.0f), vec3(1.0f, 0.0f, 0.0f), vec3(50.0f, 7.0f, -50.0f), 20.0, 1.2, true });
