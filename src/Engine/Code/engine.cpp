...
void Init(App* app)
{
    ...
    app->lights.push_back({ LightType_Point, vec3(1.0f, 1.0f, 0.0f), vec3(1.0f, 0.0f, 0.0f), vec3(0.0f, 0.0f, 0.0f) });
    app->lights.push_back({ LightType_Point, vec3(1.0f, 1.0f, 0.5f), vec3(0.0f, 1.0f, 0.0f), vec3(5.0f, 7.0f, 0.0f) });
